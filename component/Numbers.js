          ...
          <div className="row">
            ...
            <div className={`imagemanager ${styles.parallaxImage}`}>
              <div className={styles.parallaxImageInner} ref={imageRef}>
                <Image src='/number-banner.webp' width='1600' height='1040' alt="SS Group" priority />
              </div>
              </div>
              <div className="numbercount position-absolute top-0 bottom-0 left-0 right-0 col-12 float-start d-flex align-items-center">
                <div className="numberrow position-absolute col-12 float-start flex-center gap-5 align-items-center">
                        <div className="numbercolumn">
                            ...
                            <Counter startValue={10} endValue={29} speed={300} className="m-0 p-0"/> <span>+</span>
                            </div>
                        ...
                        <div className="numbercolumn">
                        <div className="countercount">
                        <Counter startValue={100} endValue={173} speed={300} className="m-0 p-0"/> 
                            </div>
                            <div className="countercont">
                        ...
                        <div className="numbercolumn">
                        <div className="countercount">
                        <Counter startValue={50000} endValue={75000} speed={300} className="m-0 p-0"/> 
                        <span>+</span>
                            </div>
                            <div className="countercont">
                        <p> CUSTOMERS </p>
